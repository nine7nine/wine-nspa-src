...
/* Directory bypass — always-on as of 2026-05-04 (env-gate retired).
 * try_bypass handles paths that stat() reveals as S_ISDIR via the
 * `kind` plumbing through nspa_local_file_table_add /
 ...
 * nt_to_unix_file_name_with_root would reject with
 * STATUS_BAD_DEVICE_TYPE — the failure mode of the 2026-04-28 16:46
 * attempt).
 *
