...
NTSYSAPI ULONG     WINAPI NtNspaGetUnixTid(void);
NTSYSAPI NTSTATUS  WINAPI NtNspaLockCriticalSectionPI(void*);
NTSYSAPI NTSTATUS  WINAPI NtNspaUnlockCriticalSectionPI(void*);
NTSYSAPI NTSTATUS  WINAPI NtNspaCondWaitPI(void*,LONG,void*,const LARGE_INTEGER*);
NTSYSAPI NTSTATUS  WINAPI NtNspaCondSignalPI(void*,void*);
NTSYSAPI NTSTATUS  WINAPI NtNspaCondBroadcastPI(void*,void*);
