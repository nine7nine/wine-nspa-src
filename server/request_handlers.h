...
C_ASSERT( offsetof(struct new_process_request, process_flags) == 24 );
C_ASSERT( offsetof(struct new_process_request, thread_flags) == 28 );
C_ASSERT( offsetof(struct new_process_request, socket_fd) == 32 );
C_ASSERT( offsetof(struct new_process_request, access) == 36 );
C_ASSERT( offsetof(struct new_process_request, machine) == 40 );
C_ASSERT( offsetof(struct new_process_request, info_size) == 44 );
C_ASSERT( offsetof(struct new_process_request, handles_size) == 48 );
C_ASSERT( offsetof(struct new_process_request, jobs_size) == 52 );
C_ASSERT( offsetof(struct new_process_request, sd_len) == 56 );
...
C_ASSERT( offsetof(struct get_new_process_info_request, access) == 16 );
C_ASSERT( offsetof(struct get_new_process_info_request, attributes) == 20 );
C_ASSERT( sizeof(struct get_new_process_info_request) == 24 );
C_ASSERT( offsetof(struct get_new_process_info_reply, tid) == 8 );
C_ASSERT( offsetof(struct get_new_process_info_reply, handle) == 12 );
C_ASSERT( offsetof(struct get_new_process_info_reply, success) == 16 );
C_ASSERT( offsetof(struct get_new_process_info_reply, exit_code) == 20 );
C_ASSERT( sizeof(struct get_new_process_info_reply) == 24 );
...
C_ASSERT( offsetof(struct get_startup_info_request, teb) == 16 );
C_ASSERT( offsetof(struct get_startup_info_request, peb) == 24 );
C_ASSERT( sizeof(struct get_startup_info_request) == 32 );
...
C_ASSERT( offsetof(struct init_process_request, unix_pid) == 12 );
C_ASSERT( offsetof(struct init_process_request, unix_tid) == 16 );
C_ASSERT( offsetof(struct init_process_request, debug_level) == 20 );
C_ASSERT( offsetof(struct init_process_request, reply_fd) == 24 );
C_ASSERT( offsetof(struct init_process_request, wait_fd) == 28 );
C_ASSERT( sizeof(struct init_process_request) == 32 );
C_ASSERT( offsetof(struct init_process_reply, pid) == 8 );
C_ASSERT( offsetof(struct init_process_reply, tid) == 12 );
C_ASSERT( offsetof(struct init_process_reply, server_start) == 16 );
C_ASSERT( offsetof(struct init_process_reply, session_id) == 24 );
C_ASSERT( offsetof(struct init_process_reply, inproc_device) == 28 );
C_ASSERT( offsetof(struct init_process_reply, has_request_shm) == 32 );
C_ASSERT( offsetof(struct init_process_reply, has_request_channel) == 36 );
C_ASSERT( offsetof(struct init_process_reply, has_queue_sync) == 40 );
C_ASSERT( offsetof(struct init_process_reply, info_size) == 44 );
C_ASSERT( sizeof(struct init_process_reply) == 48 );
...
C_ASSERT( offsetof(struct init_thread_reply, has_request_shm) == 12 );
C_ASSERT( offsetof(struct init_thread_reply, has_queue_sync) == 16 );
...
C_ASSERT( offsetof(struct set_thread_info_request, nspa_rt_override) == 48 );
...
C_ASSERT( offsetof(struct get_message_reply, nspa_sender_tid) == 48 );
C_ASSERT( offsetof(struct get_message_reply, nspa_reply_slot) == 52 );
C_ASSERT( offsetof(struct get_message_reply, nspa_reply_gen) == 56 );
C_ASSERT( offsetof(struct get_message_reply, total) == 60 );
C_ASSERT( sizeof(struct get_message_reply) == 64 );
...
C_ASSERT( offsetof(struct start_hook_chain_reply, tier1_active) == 32 );
C_ASSERT( offsetof(struct start_hook_chain_reply, proc) == 40 );
C_ASSERT( sizeof(struct start_hook_chain_reply) == 48 );
...
C_ASSERT( offsetof(struct nspa_get_thread_queue_reply, fd_sent) == 24 );
C_ASSERT( offsetof(struct nspa_get_thread_queue_reply, sync_handle) == 28 );
...
C_ASSERT( offsetof(struct nspa_create_mapping_from_unix_fd_request, fd) == 12 );
C_ASSERT( offsetof(struct nspa_create_mapping_from_unix_fd_request, access) == 16 );
C_ASSERT( offsetof(struct nspa_create_mapping_from_unix_fd_request, flags) == 20 );
C_ASSERT( offsetof(struct nspa_create_mapping_from_unix_fd_request, file_access) == 24 );
C_ASSERT( offsetof(struct nspa_create_mapping_from_unix_fd_request, size) == 32 );
