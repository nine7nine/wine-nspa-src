...
C_ASSERT( offsetof(struct init_first_thread_reply, has_request_shm) == 32 );
C_ASSERT( offsetof(struct init_first_thread_reply, has_request_event) == 36 );
C_ASSERT( offsetof(struct init_first_thread_reply, info_size) == 40 );
C_ASSERT( sizeof(struct init_first_thread_reply) == 48 );
...
C_ASSERT( offsetof(struct init_thread_reply, has_request_event) == 16 );
...
C_ASSERT( offsetof(struct get_message_reply, total) == 56 );
